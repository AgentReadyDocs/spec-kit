...
NOTE: Single source of truth for the AGENTS.md rubric. Used by `$reviewing-agents-md` and referenced by `$authoring-agents-md`.

Intended use:
- **Authoring**: self-check a newly generated `AGENTS.md` before writing/updating it.
