...
Review of the Next.js + Prisma AGENTS.md example from `authoring-agents-md/references/example-output.md`. This demonstrates the review skill's output format with realistic scores and findings.
